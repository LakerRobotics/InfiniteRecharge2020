...
private WPI_TalonSRX flyWheelTalon;
    ...
    // TODO: This is Where the VELOCITY_TOLERANCE Is
    // ***********************************************

    public double VELOCITY_TOLERANCE = 1000;
    private boolean velocityStatus = false;
...
flyWheelTalon = new WPI_TalonSRX(19);
    ...
    public void resetFlywheelStatus() {
        velocityStatus = false;
    }

    public void setFlywheelStatus() {
        if (flyWheelTalon.getSelectedSensorVelocity() > flyWheelTalon.getClosedLoopTarget()) {
            velocityStatus = true;
            
        }
        SmartDashboard.putBoolean("Velocity Status", velocityStatus);
    }
