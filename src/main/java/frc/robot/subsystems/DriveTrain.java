...
public class DriveTrain extends Subsystem {
    ...
    private final double MINIMUM_VISION_TURN_SPEED = 0.1;           // Percent Output : value between 0 and 1
    private final double MAXIMUM_VISION_TURN_SPEED = 0.5;           // Percent Output : value between 0 and 1
