...
shootAllButton.whileHeld(new shootAll());
...
aim.whileHeld(new AimUsingChassis());
        ...
        // SmartDashboard.putData("driveUsingGyro", new driveUsingGyro());
        ...
        SmartDashboard.putData("driveDistanceUsingEncoder", new driveDistanceUsingEncoder(36, .5));         // 36 inches at 1/2 speed
