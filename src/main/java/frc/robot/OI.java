...
stopShootButton2 = new JoystickButton(operator, 7);
stopShootButton2.whenReleased(new shootStop());
prepareToShootButton = new JoystickButton(operator, 7);
...
aim.whileHeld(new AimUsingChassis());
        ...
        SmartDashboard.putData("FlyWheelWithVelocity", new FlyWheelWithVelocity(500));
        ...
        SmartDashboard.putData("IntakeMove", new IntakeMove(false));
        ...
        SmartDashboard.putData("driveUsingGyro", new driveUsingGyro(36));
        ...
        SmartDashboard.putData("driveDistanceUsingEncoder", new driveDistanceUsingEncoder(36, 0.8));
